...
LABELS = {
    ...
    30342,
    'Delete OpenVPN configuration file':
    30343,
    'Additional arguments':
    30344,
    'Run OpenVPN with superuser privileges (sudo)':
    30345,
    'Ask for sudo password':
    30346,
    'Connect VPN':
    30347,
    'Choose a name for OpenVPN configuration':
    30348,
    ...
    30351,
    'Select OpenVPN configuration to run':
    30352,
    'Enter your sudo password':
    30353,
    'Started VPN connection':
    30354,
    'Stopped VPN connection':
    30355,
    ...
    'Disconnect VPN':
    30359,
    'Select OpenVPN configuration to delete':
    30360,
